...
import org.iota.wallet.model.api.requests.AddNeighborsRequest;
import org.iota.wallet.model.api.requests.GetNeighborsRequest;
import org.iota.wallet.model.api.responses.AddNeighborsResponse;
...
public class NeighborsFragment extends BaseSwipeRefreshLayoutFragment implements View.OnClickListener, SearchView.OnQueryTextListener, TextView.OnEditorActionListener, MainActivity.OnBackPressedClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabAddButton = (FloatingActionButton) view.findViewById(R.id.fab_add_neighbor);
        fabAddButton.setVisibility(View.VISIBLE);
        revealView = (FrameLayout) view.findViewById(R.id.reavel_linearlayout);
        editTextNewAddress = (EditText) view.findViewById(R.id.neighbor_edit_text_new_ip);
        fabAddButton.setOnClickListener(this);
        neighborsHeaderTextView = (TextView) view.findViewById(R.id.connected_neighbors);
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.neighbors_swipe_container);
        recyclerView = (RecyclerView) view.findViewById(R.id.neighbor_recycler_view);
        layoutManager = new LinearLayoutManager(getActivity());
        frameLayout = (FrameLayout) view.findViewById(R.id.neighborImageFrameLayout);
